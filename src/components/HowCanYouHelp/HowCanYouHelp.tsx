...
const HowCanYouHelp: FC = () => {
    return (
        <div className="w-full flex flex-col md:flex-row">
            <div className="w-full md:w-[50%] flex items-center justify-center px-5 pb-4 md:pb-0 md:pl-10">
                <div className="flex flex-col bg-zinc-300 p-7 gap-y-3 shadow-lg overflow-visible -mt-16 md:mt-0 md:-mr-16">
                    ...
                    <p className="text-lg">
                        ...
                        in fellowship and service, demonstrating Christ&apos;s love through action. We believe in the power of
